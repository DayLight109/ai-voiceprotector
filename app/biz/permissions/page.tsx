      ...
      <div className="grid grid-cols-12 gap-5">
        ...
        <div className="col-span-12 lg:col-span-5 space-y-4">
          <div className="panel p-6">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={x.label} className="flex items-center justify-between text-[13px] font-medium">
                  <span>{x.label}</span>
                  <span className="font-mono text-[10px] uppercase tracking-[0.14em] px-2 py-1 rounded-full font-bold" style={{ background: x.ok ? "var(--mint-soft)" : "var(--canvas-2)", color: x.ok ? "var(--mint-deep)" : "var(--ink-soft)" }}>
                    {x.ok ? "已启用" : "未启用"}
                  </span>
                </li>
              ))}
          ...
          <div className="panel p-6" style={{ background: "var(--coral-soft)" }}>
            <div className="flex items-center gap-2 mb-2 font-mono text-[10px] uppercase tracking-[0.14em] font-bold text-coral-deep">
              <ShieldAlert size={12} /> 合规提醒
            </div>
            <div className="text-[12px] font-semibold text-coral-deep leading-[1.7]">
